...
export const metadata: Metadata = {
  ...
  description:
    'Professional-grade online tools for developers, designers, and businesses. Free tools for IP checking, SSL analysis, SEO optimization, code formatting, and much more.',
  keywords: [
    'online tools',
    'developer tools',
    'free tools',
          ...
          <div className="container relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Professional-grade online tools for developers, designers, and businesses. All
                completely free, fast, and secure. No registration required.
              </p>
              ...
              {categories.map((category, index) => (
                <Card key={index} hover className="group">
                  ...
                  <CardContent>
                    ...
                    <Button
                      variant="outline"
                      className="w-full group-hover:bg-primary-50 group-hover:border-primary-200 transition-colors"
                    >
                      View Tools
              ...
              {[
                {
                  name: "What's My IP",
                  href: '/whats-my-ip',
                  description: 'Check your public IP address and location',
                  icon: Globe,
                },
                {
                  name: 'JSON Formatter',
                ...
                },
                {
                  name: 'SEO Analyzer',
                  href: '/seo-analyzer',
                  description: 'Comprehensive SEO analysis with AI',
                  icon: BarChart3,
                },
                {
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center text-white">
              ...
              <p className="text-xl mb-8 opacity-90">
                Join thousands of developers and professionals who trust our tools for their daily
                work
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
