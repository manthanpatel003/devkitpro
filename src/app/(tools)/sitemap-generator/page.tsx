...
export const metadata: Metadata = {
  title: 'XML Sitemap Generator - Free Sitemap Creator',
  description: 'Generate XML sitemaps for your website. Free sitemap generator with automatic URL discovery and SEO optimization.',
  keywords: ['sitemap generator', 'XML sitemap', 'sitemap creator', 'SEO sitemap', 'website sitemap'],
  openGraph: {
    title: 'XML Sitemap Generator - Free Sitemap Creator',
    description: 'Generate XML sitemaps for your website. Free sitemap generator with automatic URL discovery.',
  },
}
...
export default function SitemapGeneratorPage() {
  ...
  const [newChangeFreq, setNewChangeFreq] = useState<'always' | 'hourly' | 'daily' | 'weekly' | 'monthly' | 'yearly' | 'never'>('monthly')
  ...
  const addUrl = () => {
    ...
    const urlData: SitemapData = {
      url: newUrl.startsWith('http') ? newUrl : `${baseUrl}${newUrl.startsWith('/') ? '' : '/'}${newUrl}`,
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">XML Sitemap Generator</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>URLs in Sitemap ({urls.length})</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Sitemap className="w-5 h-5 mr-2 text-green-600" />
                  Generated Sitemap
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  {xmlOutput && (
                    <div className="flex flex-wrap gap-3">
                      <Button
                        onClick={() => handleCopy(xmlOutput, 'Sitemap XML')}
                        variant="outline"
                        size="sm"
                      >
